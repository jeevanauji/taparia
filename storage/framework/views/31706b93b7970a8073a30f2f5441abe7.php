...
<div class="hero-section">
    ...
    <picture class="image-banner">
        <source media="(max-width: 767px)" srcset="<?php echo e(asset('frontend/images/mobile-investor.jpg')); ?>">
        <img src="<?php echo e(asset('frontend/images/BANNER_123_25_Investor_desk.jpg')); ?>" alt="Banner">
    </picture>
</div>
...
<div class="content-section">
    <div class="container-xl pt-5">
        <div class="row">
            <div class="col-md-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-offset="0">
                <img data-aos="fade-down" data-aos-anchor-placement="center-bottom" data-aos-offset="0" src="<?php echo e(asset('frontend/images/investor-man.png?p=4')); ?>" class="w-100" />
            </div>
        ...
        <div class="container d-flex flex-wrap justify-content-center gap-5">
            ...
            <div data-aos="fade-up" class="investor-card" style="    display: flex; flex-direction: column; justify-content:space-between;" onclick="highlightCard(this)">
                <div data-aos="fade-up">
                    <img src="<?php echo e(asset('frontend/images/' . $section['image'])); ?>" alt="<?php echo e($section['title']); ?>">
                    <h3><?php echo e(strtoupper($section['title'])); ?></h3>
                    <p><?php echo e($section['desc']); ?></p>
                </div>
                <a href="<?php echo e(url($section['url'])); ?>" class="btn btn-outline-primary position-relative wow fadeInRight" style="background: #676464; border-radius: 4px;" data-wow-delay="0.6s">
                    <span class="tpr-btn-text "> <?php echo e($section['button']); ?></span>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/tapariatools.com/tapariatools.tapariatools.com/resources/views/frontend/investors-desk.blade.php ENDPATH**/ ?>