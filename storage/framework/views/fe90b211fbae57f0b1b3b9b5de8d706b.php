        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="<?php echo e(route('product.create')); ?>">Product Create</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="childSubCategoryId" class="form-control select2" id="childSubCategoryId" style="width: 100%;">
                                ...
                                <option value="<?php echo e($childSubCategory->id); ?>"><?php echo e($childSubCategory->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/tapariatools.com/tapariatools.tapariatools.com/resources/views/backend/products/create.blade.php ENDPATH**/ ?>