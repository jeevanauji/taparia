        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="<?php echo e(route('childsubcategory.index')); ?>">Child Sub Category</a></li>
                </ol>
            </div>
        </div>
...
<section class="content">
    <div class="card card-primary">
        ...
        <form action="<?php echo e(route('childsubcategory.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
            ...
            <table id="example1" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>  
                        ...
                        <td><?php echo e(optional($childsubcategory->category)->name ?? 'No Category Found'); ?></td>
                        <td><?php echo e(optional($childsubcategory->subCategory)->name ?? 'No Sub Category Found'); ?></td>
                        <td><?php echo e($childsubcategory->name); ?></td>
                        <td>
                            <?php if($childsubcategory->childSubCategoryImage): ?>
                            <img src="<?php echo e(url($childsubcategory->childSubCategoryImage)); ?>" style="width: 100px;" />
                            <?php endif; ?>
                        </td>
                        <td><?php echo e($childsubcategory->created_at->format('d/m/Y')); ?></td>
                        <td>
                            <!-- Edit Button -->
                            <a href="javascript:void(0);" class="btn btn-success btn-sm" onclick="childSubCategoryEdit(<?php echo e($childsubcategory->id); ?>);">
                                <i class="fas fa-edit"></i>
                            </a>

                            <!-- Delete Button -->                          
                            <a href="<?php echo e(url('admin/childsubcategory/delete/' . $childsubcategory->id)); ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger btn-sm">
...
<script type="text/javascript">
    ...
    const childSubCategoryEdit = (childSubCategoryId) => {
        $("#modal-child-sub-category-edit .modal-dialog .modal-content").load("<?php echo e(url('admin/childsubcategory/edit')); ?>/" + childSubCategoryId, function() {
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/tapariatools.com/tapariatools.tapariatools.com/resources/views/backend/childsubcategory/index.blade.php ENDPATH**/ ?>