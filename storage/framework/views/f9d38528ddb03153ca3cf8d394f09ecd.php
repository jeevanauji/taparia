...
<div class="hero-section">
    ...
    <picture class="image-banner">
        <source media="(max-width: 767px)" srcset="<?php echo e(asset('frontend/images/aboutus-mobile.jpg')); ?>">
        <img src="<?php echo e(asset('frontend/images/aboutus-05.jpg')); ?>" alt="Banner">
    </picture>
</div>
        ...
        <div class="row me-0">
            ...
            <div class="col-md-5 pe-0 align-self-end">
                <div class="abou-img" style="margin-bottom: 0rem;">
                    <img src="<?php echo e(asset('frontend/images/about-us-1965.png')); ?>"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about-count bg-primary">
        <div class="container-xl">
            <div class="text-center" data-aos="fade-up">
                <img src="<?php echo e(asset('frontend/images/Taparia_new_logo2.png')); ?>" style="max-width: 350px;width: 100%;" data-aos="fade-up" alt="Taparia Logo">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/tapariatools.com/tapariatools.tapariatools.com/resources/views/frontend/about-us.blade.php ENDPATH**/ ?>