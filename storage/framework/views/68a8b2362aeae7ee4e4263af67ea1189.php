...
<div class="hero-section">
    ...
    <picture class="image-banner">
        <source media="(max-width: 767px)" srcset="<?php echo e(asset('frontend/images/mobile-download.jpg')); ?>">
        <img src="<?php echo e(asset('frontend/images/BANNER_123_25_Downlaod.jpg')); ?>" alt="Banner">
    </picture>
</div>
...
<div class="content-section pb-5">
    ...
    data-name="new product price list">
                    ...
                    <tr class="download-item"
                        data-year="<?php echo e(\Carbon\Carbon::parse($download->created_at)->format('Y')); ?>"
                        data-name="<?php echo e(strtolower($download->contentName)); ?>">
                        <td style="text-align:left; padding-left:1rem;" data-label="Resource"><?php echo e($download->contentName); ?></td>
                        <td data-label="Download">
                            <a href="public/<?php echo e($download->pdfFile); ?>" target="_blank" aria-label="Download <?php echo e($download->contentName); ?>">
                                <span class="material-icons" style="font-size: 16px;"></span> Download
                            </a>
                        </td>
                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/tapariatools.com/tapariatools.tapariatools.com/resources/views/frontend/downloads.blade.php ENDPATH**/ ?>