<?php $__env->startSection('title'); ?>
    <?php echo e($productInfo->productName); ?>
...
@media (max-width: 480px) {
    ...
    <div class="hero-section" style="position: relative; height: 450px; overflow: hidden;">
        ...
        <div class="videobanner" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 0;">
            <div class="image-banner" style="width: 100%; height: 450px;">
                <img src="<?php echo e(asset('frontend/images/newProduct_all.jpg')); ?>" alt="Banner"
    ...
    <nav aria-label="breadcrumb" id="brdcrumsection"
        ...
        <ol class="breadcrumb mb-0"
            ...
            <?php if($productInfo->categoryId): ?>
                <li style="margin: 0 10px; color: #74BCC6; font-size: 20px; font-weight: bold;">›</li>
                <li class="breadcrumb-item" style="display: flex; align-items: center;">
                    <a href="<?php echo e(url('category/' . Str::slug($productInfo->category->name))); ?>"
                        style="color: #74BCC6; font-weight: 600; font-size: 18px; text-decoration: none; padding: 8px 15px; border-radius: 8px; transition: all 0.3s ease; background: rgba(116, 188, 198, 0.1); border: 1px solid transparent; display: flex; align-items: center;">
                        <svg style="width: 18px; height: 18px; margin-right: 8px; fill: currentColor;" viewBox="0 0 24 24">
                            <path
                                d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c.4.4 1 .4 1.4 0l.9-.9c.4-.4.4-1 0-1.4z" />
                        </svg>
                        <?php echo e(ucwords(strtolower($productInfo->category->name))); ?>

                    </a>
                </li>
            <?php endif; ?>

            <?php if($productInfo->subCategoryId): ?>
                <li style="margin: 0 10px; color: #74BCC6; font-size: 20px; font-weight: bold;">›</li>
                <li class="breadcrumb-item" style="display: flex; align-items: center;">
                    <a href="<?php echo e(url('sub-category/' . Str::slug($productInfo->subCategory->name))); ?>"
                        style="color: #74BCC6; font-weight: 600; font-size: 18px; text-decoration: none; padding: 8px 15px; border-radius: 8px; transition: all 0.3s ease; background: rgba(116, 188, 198, 0.1); border: 1px solid transparent; display: flex; align-items: center;">
                        <svg style="width: 18px; height: 18px; margin-right: 8px; fill: currentColor;" viewBox="0 0 24 24">
                            <path
                                d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c.4.4 1 .4 1.4 0l.9-.9c.4-.4.4-1 0-1.4z" />
                        </svg>
                        <?php echo e(ucwords(strtolower($productInfo->subCategory->name))); ?>
            ...
            <li class="breadcrumb-item active" aria-current="page" style="display: flex; align-items: center;">
                <span
                    ...
                    <?php echo e(ucwords(strtolower($productInfo->productName))); ?>
            ...
            <div class="row">
                    ...
                    <div class="detailsSLider">
                        <div class="outer">
                                    ...
                                    <?php $__currentLoopData = $productImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item">
                                            <div class="magnify-container image-zoom-container"
                                                ...
                                                <img src="<?php echo e(url($productImg->productImage)); ?>"
                            ...
                            <div id="thumbs" class="owl-carousel owl-theme">
                                <?php $__currentLoopData = $productImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item">
                                        <img src="<?php echo e(url($productImg->productImage)); ?>" class="img-fluid" />
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                ...
                <div class="col-md-7 mt-4 mt-md-0">
                    <div class="bg-headings">
                        <h3 style="font-size: 1.8rem;color:#74BCC6;"><?php echo e($productInfo->productName); ?></h3>
                    </div>
                    <!-- Download Button -->
                    <div class="catelog-d-btn mt-3 mb-3 text-left">
                        <a href="<?php echo e($productInfo->productCatalogue ? url('public/' . $productInfo->productCatalogue) : 'javascript:void(0);'); ?>" target="_blank" title="Download Product Catalogue" download="" style="background: #676464; border-radius: 4px;" href="#"
            ...
            <div class="row mt-5">
                <div class="col-md-6">
                    <div class="product-description">
                        ...
                        <?php echo $productInfo->productHighlighting; ?>
                ...
                <div class="col-md-6 mt-4 mt-md-0">
                    <div class="product-description">
                        ...
                        <?php echo $productInfo->productSpecifications; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/tapariatools.com/tapariatools.tapariatools.com/resources/views/frontend/product-details.blade.php ENDPATH**/ ?>