...
<!-- <div class="hero-section inner-hero">
    <div class="innerbanner">
        <img src="<?php echo e(asset('frontend/images/' . $imgName)); ?>" class="img-fluid" />
    </div>
    <div class="bannertxt">
        <div class="hero-text">
...
<div class="content-section pb-5">
    ...
    margin: 0 auto;">
            <h2 style="margin-bottom:0px;"><?php echo e(ucfirst($contentTypeName)); ?></h2>
            ...
            <table class="table table-bordered table-hover align-middle text-center">
                ...
                <tbody id="downloadsContainer">
                    ...
                    <tr class="download-item"
                        data-year="<?php echo e(\Carbon\Carbon::parse($report->created_at)->format('Y')); ?>"
                        data-name="<?php echo e(strtolower($report->contentName)); ?>">
                        <td style="text-align:left" data-label="Name"><?php echo e($report->contentName); ?></td>
                        <!--<td data-label="Year"><?php echo e(\Carbon\Carbon::parse($report->created_at)->format('Y')); ?></td>-->
                        <td data-label="Download">
                            <a href="<?php echo e(url('public/' .$report->pdfFile)); ?>" target="_blank" aria-label="Download <?php echo e($report->contentName); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/tapariatools.com/tapariatools.tapariatools.com/resources/views/frontend/investors-desk-reports.blade.php ENDPATH**/ ?>