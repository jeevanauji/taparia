        ...
        <div id="heroSlider" class="carousel slide">
            ...
            <div class="carousel-inner">
               ...
               <div class="image-banner">
    			<img
        		src="{{ asset('frontend/images/slide2.jpg') }}"
        		alt="Banner"
        		srcset="
            	{{ asset('frontend/images/home_mobile.jpg') }} 768w,
            	{{ asset('frontend/images/slide2.jpg') }} 1920w"
                ...
                <div class="carousel-item" style="position: relative;">
                    <div class="image-banner">
                        <img src="{{ asset('frontend/images/slide3.jpg') }}" alt="Banner" srcset="{{ asset('frontend/images/slide3.jpg') }} 1920w,
            ...
            <div class="carousel-item">
                <div class="image-banner">
                    <img src="{{ asset('frontend/images/slide4.jpg') }}" alt="Banner" srcset="{{ asset('frontend/images/slide4.jpg') }} 1920w,
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="hover-section text-center">
                        <h4>
                            <a href="{{ url('product/' . Str::slug($newproduct->productName)) }}" class="text"
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 wow fadeInLeft">
                ...
                <img src="{{ asset('frontend/images/about-us.png?p=5') }}" 
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 wow fadeInRight order-1 order-lg-2">
                <!-- Add loading="lazy" and decoding="async" -->
                <img src="{{ asset('frontend/images/sustainable.png') }}" 
                     class="img-fluid slide-up-animation" 
                     loading="lazy" 
                     decoding="async" 
                     alt="Legacy" />
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{ url('product/box-spanner')}}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{ url('product/cup-wheel') }}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{url('product/electric-hammer')}}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{ url('product/f-clamp') }}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{ url('product/half-moon-spanner') }}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{ url('product/mini-plier') }}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{ url('product/pipe-vices')}}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{ url('product/screw-drivers-bits-set-80-pcs') }}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="text-center mt-2">
                    <a href="{{ url('product/vde-pliers-set') }}" class="btn btn-outline-primary" style="border-color:#676464; color:white;">Read More</a>
                </div>
            </div>
        ...
        <div class="teh-content-wrapper wow fadeInUp">
            <div class="teh-scroll-container" id="teh-main-scroll">
                <div class="teh-scroll-content" id="teh-scroll-content">
                      <div class="teh-tool-item" data-image="{{ asset('frontend/images/adjustable-spanner.png') }}">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/socket-loose.png') }}">
                    <div class="teh-tool-content ">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/Cclamp.jpg') }}">
                    <div class="teh-tool-content ">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/BPCPHammers.jpg') }}">
                    <div class="teh-tool-content ">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/PipeWrench.jpg') }}">
                    <div class="teh-tool-content ">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/Chisel1.jpg') }}">
                    <div class="teh-tool-content ">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/bolt-cutters-blades.png') }}">
                    <div class="teh-tool-content ">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/Punches1.jpg') }}">
                    <div class="teh-tool-content ">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/UniversalToolKit.jpg') }}">
                    <div class="teh-tool-content ">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const newProducts = @json($newProducts ?? []); // Laravel variable
