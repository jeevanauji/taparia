    ...
    <div class="hero-section">
        <div class="videobanner">
            <div class="image-banner">
                ...
                <img data-aos="fade-up" src="{{ asset('/frontend/images/newProduct_all.jpg') }}" alt="Banner" class="img-fluid">
            </div>
    ...
    <ol class="breadcrumb">
        ...
        @if(Str::startsWith(request()->path(), 'category/'))
            ...
            <li class="breadcrumb-item active">
                <a href="{{ url('category/' . Str::slug($titleName)) }}">
                    <svg viewBox="0 0 24 24">
                        <path d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c.4.4 1 .4 1.4 0l.9-.9c.4-.4.4-1 0-1.4z" />
                    </svg>
        ...
        @if(Str::startsWith(request()->path(), 'sub-category/'))
            <li class="separator">›</li>
            <li class="breadcrumb-item">
                <a href="{{ url('category/' . Str::slug($categoryName->name)) }}">
                    <svg viewBox="0 0 24 24">
                        <path d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c.4.4 1 .4 1.4 0l.9-.9c.4-.4.4-1 0-1.4z" />
                    </svg>
            ...
            <li class="breadcrumb-item active">
                <a href="{{ url('sub-category/' . Str::slug($titleName)) }}">
                    <svg viewBox="0 0 24 24">
                        <path d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c.4.4 1 .4 1.4 0l .9-.9c.4-.4.4-1 0-1.4z" />
                    </svg>
                    {{ ucwords(strtolower($titleName)) }}
        ...
        @if(Str::startsWith(request()->path(), 'child-sub-category/'))
            ...
            <li class="breadcrumb-item">
                <a href="{{ url('sub-category/' . Str::slug($subCategoryName->name)) }}">
                    <svg viewBox="0 0 24 24">
                        <path d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c .4 .4 1 .4 1.4 0l .9-.9c .4-.4 .4-1 0-1.4z" />
                    </svg>
            ...
            <li class="breadcrumb-item active">
                <a href="{{ url('child-sub-category/' . Str::slug($titleName)) }}">
                    <svg viewBox="0 0 24 24">
                        <path d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c .4 .4 1 .4 1.4 0l .9-.9c .4-.4 .4-1 0-1.4z" />
                    </svg>
                    {{ ucwords(strtolower($titleName)) }}
                            ...
                            <div class="custom-accordion" id="categoryAccordion">
                                @foreach ($categories as $category)
                                    ...
                                    <div class="custom-item">
                                        <div class="custom-header" data-target="#cat{{ $category->id }}">
                                            <a href="{{ url('category/' . Str::slug($category->name)) }}"
                                                class="title {{ request()->is('category/' . Str::slug($category->name)) ? 'active-link' : '' }}">
                                                {{ $category->name }}
                                            </a>
                                            @if($categorySubCategories->isNotEmpty() || $categoryProducts->isNotEmpty())
                                                <button class="custom-toggle" type="button"><i class="fa-solid fa-chevron-right" style="color: #fff; font-size: 12px;"></i></button>
                                            @endif
                                        </div>

                                        <div class="custom-body" id="cat{{ $category->id }}">
                                            @if ($categorySubCategories->isNotEmpty())
                                                <div class="custom-accordion custom-sub" id="sub{{ $category->id }}">
                                                    @foreach ($categorySubCategories as $subCategory)
                                                        ...
                                                        @endphp
                                                        <div class="custom-item">
                                                            <div class="custom-header" data-target="#subcat{{ $subCategory->id }}">
                                                                <a href="{{ url('sub-category/' . Str::slug($subCategory->name)) }}"
                                                                    class="title {{ request()->is('sub-category/' . Str::slug($subCategory->name)) ? 'active-link' : '' }}">
                                                                    {{ $subCategory->name }}
                                                                </a>
                                                            ...
                                                            <div class="custom-body custom-products" id="subcat{{ $subCategory->id }}">
                                                                @if ($subCategoryProducts->isNotEmpty())
                                                                    <ul>
                                                                        @foreach ($subCategoryProducts as $product)
                                                                            <li>
                                                                                <a href="{{ url('product/' . Str::slug($product->productName)) }}"
                                                                                    class="{{ request()->is('product/' . Str::slug($product->productName)) ? 'active-link' : '' }}">
                                                                                    {{ $product->productName }}
                                                                                </a>
                                                                            </li>
                                                                        @endforeach
                                            ...
                                            @elseif ($categoryProducts->isNotEmpty())
                                        ...
                                        <div class="product-list-img" data-aos="fade-up">
                                            @if ($subCategoryData['subCategory']->subCategoryImage)
                                                <img data-aos="fade-up"
                                                    src="{{ url($subCategoryData['subCategory']->subCategoryImage) }}"
                                                    class="img-fluid" alt="{{ $subCategoryData['subCategory']->name }}" />
                                            @else
                                                <img data-aos="fade-up" src="{{ asset('frontend/images/default.jpg') }}"
                                                    class="img-fluid" alt="Default Image" />
                                            @endif
                                        </div>
                                        <div class="subcateLists">
                                            <div>
                                                <a href="{{ url('sub-category/' . Str::slug($subCategoryData['subCategory']->name)) }}"
                                                    style="text-decoration: none;">
                                                    <h4 style="margin-top: 0px;">{{ $subCategoryData['subCategory']->name }}
                                                    </h4>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-list-box">
                                        <div class="product-list-img" data-aos="fade-up">
                                            @if ($childSubCategoryData['childSubCategory']->childSubCategoryImage)
                                                <img data-aos="fade-up"
                                                    src="{{ url($childSubCategoryData['childSubCategory']->childSubCategoryImage) }}"
                                                    class="img-fluid" alt="{{ $childSubCategoryData['childSubCategory']->name }}" />
                                            @else
                                                <img data-aos="fade-up" src="{{ asset('frontend/images/default.jpg') }}"
                                                    class="img-fluid" alt="Default Image" />
                                            @endif
                                                ...
                                                @if($totalProductChunks > 0)
                                                        ...
                                                        <div class="subcate-slides" id="product-slides-{{ $index }}">
                                                            @foreach ($productChunks as $chunkIndex => $productChunk)
                                                                <div class="subcate-slide">
                                                                    ...
                                                                    <h4 class="mb-2">
                                                                        {{ $childSubCategoryData['childSubCategory']->name }}
                                                                    </h4>
                                                    ...
                                                    @if($totalProductChunks > 1)
                                                        <div class="subcate-pagination">
                                                            <button class="pagination-btn" id="product-prev-{{ $index }}"
                                                                disabled>‹</button>
                                                            <span style="font-size: 0.8rem; color: #fff;">
                                                                <span
                                                                    id="product-current-{{ $index }}">1</span>/{{ $totalProductChunks }}
                                                            </span>
                            ...
                            <div class="col-md-6 mt-3 mt-md-0 pb-3" style="width:100%">
                                <div class="product-list-box">
                                    <div class="product-list-img">
                                        <img data-aos="fade-up"
                                            src="{{ url($childSubCategoryData->childSubCategoryImage) }}" class="img-fluid"
                                            alt="{{ $childSubCategoryData->name }}" />
                                    </div>
                                    <div class="subcateLists">
                                        <div>
                                            <ul class="list-unstyled">
                                                @foreach ($productsByChildSubCategory as $childSubCategoryProduct)
                                                    <li>
                                                        <a
                                                            href="{{ url('product/' . Str::slug($childSubCategoryProduct->productName)) }}">
                                                            {{ $childSubCategoryProduct->productName }}
                                                        </a>
                                                    </li>
                                                @endforeach
                                    ...
                                    <div class="product-list-box">
                                        <div class="product-list-img">
                                            @if ($categoryData->categoryImage)
                                                <img data-aos="fade-up" src="{{ url($categoryData->categoryImage) }}"
                                                    class="img-fluid" alt="{{ $categoryData->name }}" />
                                            @else
                                                <img data-aos="fade-up" src="{{ asset('frontend/images/default.jpg') }}"
                                                    class="img-fluid" alt="Default Image" />
                                            @endif
                                        ...
                                        <div class="subcateLists">
                                            <div>
                                                <a href="{{ url('category/' . Str::slug($categoryData->name)) }}"
                                                    style="text-decoration: none;">
