...
<section class="section-padd about-section" style="padding-top:50px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 wow fadeInLeft" data-aos="fade-up">
            ...
            <div class="col-lg-5 mt-5 mt-lg-0">
                <div class="heading-con align-items-end text-end w-100">
                    <h2 class="wow fadeInUp mb-0 pe-md-5" style="    width: 100%;  display: flex;   flex-direction: column;    align-items: start;">ABOUT US <div style="width: 34%; height: 1px; background-color: #74BCC6; "></div>
                    </h2>
                ...
                <div class="wow fadeInLeft mt-4" style="font-size: 16px;" data-aos="fade-up">
                    <p>
...
<section class="sustainble-section">
    <div class="container">
        <div class="sustainble-con section-padding-70" data-aos="fade-up">
...
<section class="section-padd-t features-categories py-md-5">
    <div class="container">
        <div class="text-center">
            <div class="heading-con" data-aos="fade-up">
                ...
                <div data-aos="fade-up"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4 mb-5">
                            <div class="best-pro-box" data-aos="fade-up">
                                @if ($product->productImage)
                                <img data-aos="fade-up" src="{{ url($product->productImage) }}" />
                                @else
                                <img data-aos="fade-up" src="{{ asset('frontend/images/default.jpg') }}" />
                                @endif
                                <div class="hover-section text-center" data-aos="fade-up">
                                    <h4>
...
<section class="teh-section">
    ...
    <div class="container">
        <div class="text-center">
            ...
            <p class="wow fadeInUp" style="margin-bottom: 50px;" data-aos="fade-up">Discover our premium range of professional tools designed for precision, durability, and exceptional performance.</p>
        </div>
    </div>

    <div class="teh-content-wrapper">
        <div class="teh-scroll-container" id="teh-main-scroll">
            <div class="teh-scroll-content" id="teh-scroll-content" data-aos="fade-up">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/screw-driver.png') }}" data-aos="fade-up">
                    <div class="teh-tool-content">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/ring-spanners.png') }}" data-aos="fade-up">
                    <div class="teh-tool-content">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/line-testers.png') }}" data-aos="fade-up">
                    <div class="teh-tool-content">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/allen-keys.png') }}" data-aos="fade-up">
                    <div class="teh-tool-content">
                ...
                <div class="teh-tool-item" data-image="{{ asset('frontend/images/socket-set.png') }}" data-aos="fade-up">
                    <div class="teh-tool-content">
            ...
            <div class="teh-image-display" data-aos="fade-up">
