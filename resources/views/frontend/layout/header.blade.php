...
.type {
    ...
    <div class="side-download-buttons">
        <a href="{{ url('downloads') }}" class="side-download-btn catalogue-btn" title="Download Catalogue">
        ...
        <a href="{{ asset('frontend/images/pricelist.pdf') }}" download="pricelist.pdf" class="side-download-btn price-list-btn" title="Download Price List">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 16a1 1 0 0 1-.707-.293l-4-4a1 1 0 1 1 1.414-1.414L11 12.586V4a1 1 0 1 1 2 0v8.586l2.293-2.293a1 1 0 1 1 1.414 1.414l-4 4A1 1 0 0 1 12 16zm-7 4a1 1 0 0 1-1-1v-2a1 1 0 1 1 2 0v1h12v-1a1 1 0 1 1 2 0v2a1 1 0 0 1-1 1H5z" />
            </svg>
    ...
    <div class="top-strip">
        <a class="navbar-brand" href="{{ url('') }}">
            <img src="{{ asset('frontend/images/latestlogotaparia.png') }}" alt="Taparia Logo" style="width: 100%; ">
        </a>
        ...
        <div class="d-flex align-items-center flex-wrap gap-4 testing">
            <div class="d-flex gap-3 social-icons pe-4" style="border-right:1px solid #74BCC6;">
                <a href="{{ url('category/new-products') }}"  style="color:#2483B2; border:2px solid #2483B2;" class="shine-btn">New Products</a>
            </div>
            <div class="d-flex gap-4 social-icons pe-4" style="border-right:1px solid #74BCC6;">
                <!-- <a styele= href="https://facebook.com" target="_blank"><img style="width:120px;" src="{{ asset('frontend/images/flpkartlogo.png') }}">				</a>-->
                <a href="https://www.amazon.in/s?k=taparia+tools&crid=20R90A3J6M9ER&sprefix=taparia+tools%2Caps%2C186&ref=nb_sb_noss_2" target="_blank"><img style="width:120px;" src="{{ asset('frontend/images/logo_-01-05.png') }}"></a>
            </div>
            ...
            <div class="navbar-collapse" id="mainNavbar" style="display: none;">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item mega-menu-container position-static">
                        <a class="nav-link  dropdown-toggle {{ Request::is('products*') ? 'active' : '' }}" href="{{ url('products') }}">
                            Products
                                    ...
                                    <div class="category-group" data-category-id="{{ $category->id }}">
                                        ...
                                        <div class="subcategory-panel">
                                            <ul class="subcategory-list">
                                                ...
                                                <li class="subcategory-item" data-sub-id="{{ $subCategory->id }}">
                                                    <a
                                                        href="{{ url('sub-category/' . Str::slug($subCategory->name)) }}">
                                                        {{ $subCategory->name }}
                                        ...
                                        <div class="products-panel" data-sub-id="{{ $subCategory->id }}">
                                            <ul class="products-list">
                                                @foreach($subCategory->products as $product)
                                                <li>
                                                    <a href="{{ url('product/' . Str::slug($product->productName)) }}">
                                                        {{ $product->productName }}
                                                    </a>
                                                </li>
                                                @endforeach
...
<ul class="dropdown-menu d-lg-none">
    ...
    <li>
        ...
        <ul class="mobile-subcategory-list" id="{{ \Illuminate\Support\Str::slug($category->name) }}-sub">
            @foreach($category->subCategories as $subCategory)
            <li>
                @if($subCategory->products && $subCategory->products->count())
                <div class="subcategory-toggle-mobile" data-subcategory="{{ \Illuminate\Support\Str::slug($subCategory->name) }}">
                ...
                <ul class="mobile-products-list"  id="{{ \Illuminate\Support\Str::slug($subCategory->name) }}-products">
                    @foreach($subCategory->products as $product)
                    <li>
                        <!-- Product link for mobile -->
                        <a href="{{ url('product/' . \Illuminate\Support\Str::slug($product->productName)) }}">
                            {{ $product->productName }}
                        </a>
                    </li>
                    @endforeach
    ...
    @endforeach
                ...
                <ul class="navbar-nav  mb-2 mb-lg-0" style="margin-right:120px">
                    <li class="nav-item"><a class="nav-link nav-links {{ Request::is('/') ? 'active' : '' }}" href="{{ url('') }}">Home</a></li>
                    <li class="nav-item"><a class="nav-link nav-links {{ Request::is('about-us') ? 'active' : '' }}" href="{{ url('about-us') }}">About Us</a></li>
                    <li class="nav-item"><a class="nav-link nav-links {{ Request::is('investors-desk') ? 'active' : '' }}" href="{{ url('investors-desk') }}">Investors Desk</a></li>
                    <li class="nav-item"><a class="nav-link nav-links {{ Request::is('downloads') ? 'active' : '' }}" href="{{ url('downloads') }}">Downloads</a></li>
                    <li class="nav-item"><a class="nav-link nav-links {{ Request::is('distributors') ? 'active' : '' }}" href="{{ url('distributors') }}">Distributors</a></li>
                    <li class="nav-item"><a class="nav-link nav-links {{ Request::is('contact-us') ? 'active' : '' }}" href="{{ url('contact-us') }}">Contact Us</a></li>
                </ul>
