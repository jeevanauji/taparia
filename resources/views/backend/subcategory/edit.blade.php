        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select class="form-control select2" id="categorySelect" name="category_id" style="width: 100%;" required="">
                        <option value="" {{ $subCategory->categoryId == '' ? 'selected' : '' }}>Select Category</option>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="subcategoryName" name="name" value="{{ $subCategory->name }}" placeholder="Enter Subcategory name" pattern="[A-Za-z\s]+" title="Subcategory name should only contain alphabetic characters and spaces." required>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="hidden" name="oldSubCategoryImage" value="{{ $subCategory->subCategoryImage }}" />
                </div>
            </div>
        </div>        
    </div>
