...
<div class="content-section" style="padding: 60px 15px;">
    ...
    <a href="#" class="btn-user-login"
       ...
       style="
            ...
            outline: none;
       "
       onmouseover="this.style.backgroundColor='#74BCC6'; this.style.boxShadow='0 6px 16px rgb(103, 100, 100)'"
       onmouseout="this.style.backgroundColor='#676464'; this.style.boxShadow='0 4px 12px rgba(103, 100, 100, 0.5)'"
