...
<style type="text/css">
    ...
    .product-description ul li, .product-description ul li, .product-description table, .product-description table {
        width: 100% !important;
    }
    ...
    .product-description img, .product-overview img {
        max-width: 100%;
    }
...
<div class="hero-section" style="position: relative; height: 450px; overflow: hidden;">
    ...
    <div class="videobanner" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 0;">
        <div class="image-banner" style="width: 100%; height: 450px;">
            <img src="{{ asset('frontend/images/main_product.jpg') }}" alt="Banner" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
    </div>
...
<nav aria-label="breadcrumb" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); padding: 15px 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(116, 188, 198, 0.1); margin: 20px 0px 30px 50px; border: 1px solid rgba(116, 188, 198, 0.2);">
    <ol class="breadcrumb mb-0" style="margin: 0; padding: 0; list-style: none; display: flex; align-items: center; flex-wrap: wrap;">
        ...
        <li style="margin: 0 10px; color: #74BCC6; font-size: 20px; font-weight: bold;">›</li>
        <li class="breadcrumb-item" style="display: flex; align-items: center;">
            <a href="{{ url('category/' . Str::slug($productInfo->category->name)) }}" style="color: #74BCC6; font-weight: 600; font-size: 18px; text-decoration: none; padding: 8px 15px; border-radius: 8px; transition: all 0.3s ease; background: rgba(116, 188, 198, 0.1); border: 1px solid transparent; display: flex; align-items: center;">
                <svg style="width: 18px; height: 18px; margin-right: 8px; fill: currentColor;" viewBox="0 0 24 24">
                    <path d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c.4.4 1 .4 1.4 0l.9-.9c.4-.4.4-1 0-1.4z"/>
                </svg>
        ...
        <li style="margin: 0 10px; color: #74BCC6; font-size: 20px; font-weight: bold;">›</li>
        <li class="breadcrumb-item" style="display: flex; align-items: center;">
            <a href="{{ url('sub-category/' . Str::slug($productInfo->subCategory->name)) }}" style="color: #74BCC6; font-weight: 600; font-size: 18px; text-decoration: none; padding: 8px 15px; border-radius: 8px; transition: all 0.3s ease; background: rgba(116, 188, 198, 0.1); border: 1px solid transparent; display: flex; align-items: center;">
                <svg style="width: 18px; height: 18px; margin-right: 8px; fill: currentColor;" viewBox="0 0 24 24">
                    <path d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c.4.4 1 .4 1.4 0l.9-.9c.4-.4.4-1 0-1.4z"/>
                </svg>
        ...
        <li class="breadcrumb-item active" aria-current="page" style="display: flex; align-items: center;">
            <span style="color: #ffffff; font-weight: 700; font-size: 18px; padding: 8px 15px; border-radius: 8px; background: linear-gradient(135deg, #74BCC6 0%, #5aa8b3 100%); box-shadow: 0 2px 8px rgba(116, 188, 198, 0.3); display: flex; align-items: center; border: 1px solid #74BCC6;">
                <svg style="width: 18px; height: 18px; margin-right: 8px; fill: currentColor;" viewBox="0 0 24 24">
                    <path d="M22.7 19.3l-4.2-4.2c1.1-2.1.7-4.7-1.1-6.4-1.8-1.8-4.5-2.2-6.6-1l2.2 2.2-2.1 2.1-2.2-2.2c-1.2 2.1-.8 4.8 1 6.6 1.7 1.7 4.3 2.2 6.4 1.1l4.2 4.2c.4.4 1 .4 1.4 0l.9-.9c.4-.4.4-1 0-1.4z"/>
                </svg>
        ...
        <div class="row">
                    ...
                    <div class="outer">
                        ...
                        <div class="main-image-container">
                            <div id="big" class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <div class="magnify-container image-zoom-container" onmousemove="magnify(event, this)" onmouseleave="hideMagnify(this)">
                                        <img src="{{ url($productImg->productImage) }}" class="img-fluid main-product-image" onclick="openFullscreen(this.src)" />
            ...
            <div class="col-md-7 mt-4 mt-md-0">
                ...
                <div class="catelog-d-btn mt-3 mb-3 text-left">
                    <a href="{{ $productInfo->productCatalogue ? url($productInfo->productCatalogue) : 'javascript:void(0);' }}"
                       target="_blank"
                       ...
                       onmouseout="this.style.backgroundColor='#74bcc6'; this.style.boxShadow='0 4px 12px rgba(103, 100, 100, 0.5)'"
...
function magnify(event, container) {
    ...
    const zoom = container.querySelector('.magnify-zoom');
    ...
    // Keep glass within image bounds
    const glassSize = 80;
    let glassX = Math.max(0, Math.min(x - glassSize/2, rect.width - glassSize));
    let glassY = Math.max(0, Math.min(y - glassSize/2, rect.height - glassSize));
    ...
    const bgX = -((x / rect.width) * (imgRect.width * zoomRatio) - 150);
    const bgY = -((y / rect.height) * (imgRect.height * zoomRatio) - 150);
